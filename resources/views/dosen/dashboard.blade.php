                                    ...
                                    <div class="col-md-12 mr-auto text-left">
                                        <div class="custom-search input-group">
                                            <div class="custom-breadcrumb">
                                                ...
                                                <h4 class="text-dark">Dosen Dashboard</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card dash-widget ctm-border-radius shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="card-right">
                                        <h4 class="card-title">Total Antri Keluhan</h4>
                                        <p class="card-text">{{ $totalKeluhanBelumdiBalas }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="card dash-widget ctm-border-radius shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="card-right">
                                        <h4 class="card-title">Total Keluhan</h4>
                                        <p class="card-text">{{ $totalKeluhan }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
