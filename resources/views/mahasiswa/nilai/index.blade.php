                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    <li class="list-group-item text-center active button-5"><a
                                            href="{{ url('/mahasiswa/jadwal') }}" class="text-white">All</a></li>
                                </ul>
                            </div>
                        </div>
                    </aside>
                                ...
                                <div class="table-responsive">
                                    <table class="table custom-table table-hover table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th> IPK </th>
                                                <td> {{ round($nilaiAngka, 2) }} </td>
                                            </tr>
                                            <tr>
                                                <td colspan="10" align="center">
                                                    <a href="{{ url('/mahasiswa/mata-kuliah') }}"><button
                                        ...
                                        <tbody>
                                            @foreach ($mataKuliah as $i => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ count($nilaiRataRata) > 0 ? $nilaiRataRata[$i] : '' }}</td>
                                                    <td class="text-left" align="center">
                                                        <div class="table-action">
                                                            <a href="{{ url('/mahasiswa/nilai/' . $item->id_mata_kuliah_enroll) }}"
                                                                title="View Jadwal"><button
